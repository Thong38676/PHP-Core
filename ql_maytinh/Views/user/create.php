...
<div class="container" style="margin-left: 19%">
  <div class="card mt-2 col-10">
    <div class="card-header">
      <h5 style="text-align: center">CREATE User</h5>
    </div>
    <div class="card-body">
      <form class=" mt-5 mr-6" method="post">
        <div class="form-group row">
          <label  class="col-sm-2 col-form-label">Ten đăng nhâp</label>
          <div class="col-sm-10">
        ...
        <div class="form-group row" style="margin-left: 15.5%">
          <div class="col-sm-10">
            ...
            <!-- <a href="?danhsach_vungmien" class="btn btn-outline-danger">Danh Sách Các Vùng Miền</a -->
          </div>
        </div>
      </form>
    </div>
