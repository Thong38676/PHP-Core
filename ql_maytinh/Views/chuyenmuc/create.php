          ...
          <div class="container">
            <form method="POST">
              <div class="form-group">
               ...
               <input type="text" name="ten_chuyenmuc" class="form-control" style="width: 800px">
             </div>
             <div class="form-group">
               <label>Mô tả:</label>
               <input type="text" name="mota" class="form-control" style="width: 800px">
             </div>
             <button type="submit" class="btn btn-primary" name="luu_chuyenmuc">Lưu thông tin chuyên mục</button>
<!-- 		<a href="?danhsach_chuyenmuc" class="btn btn-primary">Danh sách Chuyên mục</a>
		<a href="?tao_sanpham" class="btn btn-primary">Tạo mới sản phẩm</a>
		<a href="?danhsach_sanpham" class="btn btn-primary">Danh sách Sản phẩm</a> -->
	</div>
</div>
</div>
</div>
