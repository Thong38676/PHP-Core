        ...
        <div class="panel-body">
          ...
          <form method="POST">
            ...
            <div class="form-group">
              ...
              <textarea name="mota_sanpham" class="form-control"></textarea>
            </div>
            <div class="form-group">
              <label>Gia Sản phẩm:</label>
              <input type="text" name="gia_sanpham" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="xuatxu_sanpham" class="form-control">
            </div>
            <div class="form-group">
              <label>CPU:</label>
            ...
            <div class="form-group">
              ...
              <input type="text" name="bao_hanh" class="form-control">
            </div>
            ...
            <br>
            <button type="submit" class="btn btn-primary" name="luu_sanpham">Lưu thông tin sản phẩm</button>
          </form>
        </div>
      </div>
    </div>
